...
- **AppArmor** in enforce mode (required for Open edX codejail)
- **UFW firewall** with default-deny incoming + Kubernetes-specific allow rules
...
| IPv6 disable (3.1.1) | RKE2 supports dual-stack; disabling breaks pod networking |
...
The CIS role enables UFW with default-deny. These ports are allowed post-hardening:
...
│           └── tasks/main.yml      # CIS role + post-CIS UFW rules
└── README.md                       # This file
```
